...
// Make changes to DTCAuthor.m instead.

#import "_DTCAuthor.h"

const struct DTCAuthorAttributes DTCAuthorAttributes = {
	.name = @"name",
};

const struct DTCAuthorRelationships DTCAuthorRelationships = {
	.books = @"books",
};

@implementation DTCAuthorID
@end

@implementation _DTCAuthor
...
- (DTCAuthorID*)objectID {
	return (DTCAuthorID*)[super objectID];
}
